...
def _parse_args():
    ...
    parser.add_argument(
        '--discriminator_lr', type=float, default=2e-4, help='Learning rate for the _discriminator.'
    )
    ...
    parser.add_argument(
        '--discriminator_decay', type=float, default=0, help='Weight decay for the _discriminator.'
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default='256,256',
        help='Dimension of each _discriminator layer. Comma separated integers with no whitespaces.',
    )
