...
class CTGAN(BaseSynthesizer):
    ...
    Args:
        ...
        discriminator_lr (float):
            Learning rate for the _discriminator. Defaults to 2e-4.
        discriminator_decay (float):
            Discriminator weight decay for the Adam Optimizer. Defaults to 1e-6.
        batch_size (int):
            Number of data samples to process in each step.
        discriminator_steps (int):
            Number of _discriminator updates to do for each generator update.
        ...
        pac (int):
            Number of samples to group together when applying the _discriminator.
            Defaults to 10.
        cuda (bool):
